...
<head>
    ...
    {{-- Copy Style Block dari file Create di atas --}}
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    
    <style>
        /* PASTE CSS STYLE DARI FILE CREATE DI SINI AGAR SAMA PERSIS */
...
<div class="dashboard-container">
    ...
    <main class="main-content position-relative">
        ...
        <div class="d-flex align-items-center mb-4 mt-2">
            <div>
                <h3 class="fw-bold mb-0">Edit Data Pustaka</h3>
                <p class="text-secondary small mb-0">Perbarui informasi koleksi.</p>
            </div>
        </div>
        ...
        <div class="content-card" style="max-width: 800px;">
            <form action="{{ route('dashboard.posts.update', $post->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-3">
                        <img src="{{ $post->image }}" alt="Preview" class="rounded shadow-sm" style="height: 100px; border: 1px solid var(--input-border);">
                    </div>
                </div>
                ...
                <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-warning px-4 fw-bold text-white"><i class="fa-solid fa-pen-to-square me-2"></i> UPDATE DATA</button>
                </div>
            </form>
        </div>
    </main>
